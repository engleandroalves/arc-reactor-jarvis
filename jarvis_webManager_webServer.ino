...
// ========================================================================
//Enables watchdog with setup to timeout for 4sec
...
void setup() {
  ...
  if(!res) {
    ...
    player.play(1); //  1_activate_wifi.mp3
  ...
  player.play(3); //3_setup_complete_1.mp3
  ...
  player.play(4); //3_setup_complete_1.mp3
  player.playMp3Folder(4); //3_setup_complete_1.mp3
